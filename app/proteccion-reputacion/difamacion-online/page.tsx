  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="max-w-6xl mx-auto px-4 py-3 text-xs text-stone-400">
        ...
        <span className="text-stone-700">Eliminar difamación online</span>
      </nav>
      <header className="py-14 px-4" style={{background:"#0f1729"}}>
        <div className="max-w-3xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-black text-white mb-4">Eliminar difamación online</h1>
          <p className="text-slate-400 text-lg max-w-2xl mb-5">Gestionamos la retirada de contenido difamatorio mediante las vías legales adecuadas. No prometemos resultados garantizados — prometemos máxima diligencia profesional.</p>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-3">
            <details className="group bg-white rounded-xl border border-stone-200">
              ...
              <div className="px-5 pb-4 text-sm text-stone-600 border-t border-stone-200 pt-3 leading-relaxed">La publicación de afirmaciones falsas que dañan la reputación de una persona o empresa en webs, redes o foros.</div>
            </details>
            <details className="group bg-white rounded-xl border border-stone-200">
              <summary className="flex items-center justify-between px-5 py-4 cursor-pointer font-semibold text-stone-900 text-sm list-none">
                ¿Se puede garantizar la eliminación?<span className="text-stone-400 group-open:rotate-180 transition-transform ml-3">▼</span>
              </summary>
              <div className="px-5 pb-4 text-sm text-stone-600 border-t border-stone-200 pt-3 leading-relaxed">No. Depende de la plataforma y la jurisdicción. Garantizamos gestión profesional y transparencia total.</div>
            </details>
            <details className="group bg-white rounded-xl border border-stone-200">
              <summary className="flex items-center justify-between px-5 py-4 cursor-pointer font-semibold text-stone-900 text-sm list-none">
                ¿Cuánto tarda?<span className="text-stone-400 group-open:rotate-180 transition-transform ml-3">▼</span>
              </summary>
              <div className="px-5 pb-4 text-sm text-stone-600 border-t border-stone-200 pt-3 leading-relaxed">Entre 2 y 8 semanas según la plataforma y complejidad del caso.</div>
            </details>
          </div>
        </div>
      </section>
      <section className="py-10 px-4 bg-white">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <a href="/proteccion-reputacion/suplantacion-identidad/" className="text-sm border border-stone-200 px-4 py-2 rounded-xl hover:border-stone-400 transition text-stone-600">Suplantación →</a>
          </div>
        </div>
      </section>
      <CtaBanner />
