  ...
  return (
    <div className="min-h-screen" style={{background:"var(--bg)"}}>
      ...
      <nav className="max-w-6xl mx-auto px-4 py-3 text-xs text-stone-400">
        <Link href="/" className="hover:text-stone-600">Inicio</Link> › <Link href="/proteccion-reputacion/" className="hover:text-stone-600">Protección de reputación</Link> › <span className="text-white/80">Eliminar Contenido OnlyFans — DMCA</span>
      </nav>
