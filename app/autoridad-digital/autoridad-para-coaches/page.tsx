  ...
  return (
    <div className="min-h-screen" style={{background:"var(--bg)"}}>
      ...
      <nav className="max-w-6xl mx-auto px-4 py-3 text-xs text-stone-400">
        <Link href="/" className="hover:text-stone-600">Inicio</Link> › <Link href="/autoridad-digital/" className="hover:text-stone-600">Autoridad digital</Link> › <span className="text-white/80">Autoridad Digital para Coaches e Infoproductores</span>
      </nav>
