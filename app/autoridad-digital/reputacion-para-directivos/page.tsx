...
export const metadata: Metadata = { title: "Reputación Digital para Directivos y CEOs — Reputalia", description: "Reputación Digital para Directivos y CEOs. Gestión profesional, contrato legal previo, análisis gratuito.", alternates: { canonical: "https://reputalia.es/autoridad-digital/reputacion-para-directivos//" } };
