        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-3">
            <details className="card group">
              ...
              <div className="px-5 pb-4 text-sm text-stone-600 border-t border-white/[0.07] pt-3 leading-relaxed">Wikipedia tiene criterios de notabilidad muy estrictos y su contenido es editable por cualquiera. Los wikis de autoridad son más accesibles y reconocidos por Google.</div>
            </details>
            <details className="card group">
              <summary className="flex items-center justify-between px-5 py-4 cursor-pointer font-semibold text-stone-900 text-sm list-none">
                ¿Qué incluye el pack?<span className="text-stone-400 group-open:rotate-180 transition-transform ml-3">▼</span>
              </summary>
              <div className="px-5 pb-4 text-sm text-stone-600 border-t border-white/[0.07] pt-3 leading-relaxed">FoundersWiki + WikiAlpha + Crunchbase + hasta 2 wikis adicionales según perfil.</div>
            </details>
            <details className="card group">
              <summary className="flex items-center justify-between px-5 py-4 cursor-pointer font-semibold text-stone-900 text-sm list-none">
                ¿Para qué sirven?<span className="text-stone-400 group-open:rotate-180 transition-transform ml-3">▼</span>
              </summary>
              <div className="px-5 pb-4 text-sm text-stone-600 border-t border-white/[0.07] pt-3 leading-relaxed">Son las fuentes que Google usa para construir el Knowledge Panel. Sin ellas, activar el panel es muy difícil.</div>
            </details>
          </div>
        </div>
      </section>
      <section className="py-10 px-4 bg-white">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap gap-3">
            <a href="/autoridad-digital/knowledge-panel-google/" className="text-sm border border-white/[0.07] px-4 py-2 rounded-xl hover:border-stone-400 transition text-stone-600">Knowledge Panel →</a>
            <a href="/autoridad-digital/aparecer-en-forbes/" className="text-sm border border-white/[0.07] px-4 py-2 rounded-xl hover:border-stone-400 transition text-stone-600">Forbes Argentina →</a>
