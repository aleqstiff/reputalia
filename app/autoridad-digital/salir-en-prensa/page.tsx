        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-3">
            <details className="card group">
              ...
              <div className="px-5 pb-4 text-sm text-stone-600 border-t border-white/[0.07] pt-3 leading-relaxed">Medios españoles, Forbes Argentina, y pack medios top: NYPost, BBC, Wired, PageSix, People. Cada uno con su precio real.</div>
            </details>
            <details className="card group">
              <summary className="flex items-center justify-between px-5 py-4 cursor-pointer font-semibold text-stone-900 text-sm list-none">
                ¿Es editorial o publicitario?<span className="text-stone-400 group-open:rotate-180 transition-transform ml-3">▼</span>
              </summary>
              <div className="px-5 pb-4 text-sm text-stone-600 border-t border-white/[0.07] pt-3 leading-relaxed">Siempre editorial cuando lo describimos como editorial. Nunca confundimos artículo de pago con cobertura orgánica.</div>
            </details>
            <details className="card group">
              <summary className="flex items-center justify-between px-5 py-4 cursor-pointer font-semibold text-stone-900 text-sm list-none">
                ¿Cuánto impacta en Google?<span className="text-stone-400 group-open:rotate-180 transition-transform ml-3">▼</span>
              </summary>
              <div className="px-5 pb-4 text-sm text-stone-600 border-t border-white/[0.07] pt-3 leading-relaxed">Un artículo en medio de alta autoridad genera backlink de calidad y puede aparecer al buscar tu nombre. Combinado con Knowledge Panel, el efecto es muy significativo.</div>
            </details>
          </div>
        </div>
      </section>
