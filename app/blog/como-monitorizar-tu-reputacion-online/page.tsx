      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <div className="mt-10 pt-8 border-t border-white/[0.07]">
          ...
          <div className="flex flex-wrap gap-3">
              <Link href="/monitorizacion-reputacion/proteccion-continua-marca/" className="text-sm border border-white/[0.07] px-4 py-2 rounded-xl hover:border-stone-400 transition text-stone-600">Monitorización continua →</Link>
              <Link href="/monitorizacion-reputacion/alertas-reputacion/" className="text-sm border border-white/[0.07] px-4 py-2 rounded-xl hover:border-stone-400 transition text-stone-600">Alertas de reputación →</Link>
              <Link href="/monitorizacion-reputacion/auditoria-reputacion-online/" className="text-sm border border-white/[0.07] px-4 py-2 rounded-xl hover:border-stone-400 transition text-stone-600">Auditoría gratuita →</Link>
          </div>
        </div>
      </div>
      <Footer />
