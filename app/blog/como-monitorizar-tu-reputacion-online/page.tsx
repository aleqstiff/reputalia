  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <h1 className="text-3xl md:text-4xl font-black text-stone-900 mb-5 leading-tight">Cómo monitorizar tu reputación online en 2026</h1>
        <p className="text-xl text-stone-600 leading-relaxed mb-8 border-l-4 border-amber-400 pl-4">La mejor gestión de reputación es la que actúa antes de que el daño sea irreversible. La monitorización continua es lo que hace posible esa reacción temprana. Esta guía explica cómo hacerlo.</p>
        
        <div className="prose prose-stone max-w-none">
          <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4">Por qué la monitorización activa cambia completamente el juego</h2>
          <p className="text-stone-600 leading-relaxed">La diferencia entre detectar un artículo difamatorio el día que se publica y detectarlo seis meses después es enorme. El primer caso permite actuar antes de que se indexe en Google, antes de que otros medios lo citen, y antes de que el daño reputacional se consolide. El segundo caso significa que el contenido ya está indexado, citado y difundido. Revertirlo es significativamente más costoso y lento.</p>

          <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4">Herramientas gratuitas para empezar hoy</h2>
          <p className="text-stone-600 leading-relaxed">Google Alerts (alerts.google.com): configura alertas para tu nombre, variaciones, nombre de tu empresa y términos asociados. Notificación por email cuando aparecen nuevas menciones. Es básico pero funciona para la mayoría de casos. Limitations: no cubre redes sociales, tarda en indexar, y tiene muchos falsos positivos. Complementa con búsquedas manuales periódicas (al menos mensual): tu nombre + "opiniones", tu nombre + "estafa", tu empresa + "problemas".</p>

          <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4">Cuándo necesitas monitorización profesional</h2>
          <p className="text-stone-600 leading-relaxed">Las herramientas gratuitas son insuficientes cuando: tienes un perfil público significativo (periodistas, figuras públicas, CEOs), tu empresa recibe reseñas regularmente, has tenido incidentes reputacionales previos, o estás en un sector donde los ataques coordinados son comunes (salud, finanzas, inmobiliario, restauración). La monitorización profesional añade cobertura de foros y redes sociales, análisis de sentimiento, y lo más importante: un equipo que actúa cuando detecta algo.</p>

          <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4">La regla del retainer: por qué es necesario después de construir</h2>
          <p className="text-stone-600 leading-relaxed">Si has invertido en construir tu Knowledge Panel, aparecer en medios o limpiar tu presencia online, necesitas mantener ese trabajo activo. Los Knowledge Panels se degradan si las fuentes que los alimentan dejan de actualizarse. Los perfiles de autoridad pierden relevancia. Lo construido tiene una vida útil activa, no permanente. El retainer mensual no es un extra opcional — es lo que convierte una inversión puntual en un activo duradero.</p>
        </div>
        ...
        <div className="mt-10 pt-8 border-t border-stone-200">
          ...
          <div className="flex flex-wrap gap-3">
              <Link href="/monitorizacion-reputacion/proteccion-continua-marca/" className="text-sm border border-stone-200 px-4 py-2 rounded-xl hover:border-stone-400 transition text-stone-600">Monitorización continua →</Link>
              <Link href="/monitorizacion-reputacion/alertas-reputacion/" className="text-sm border border-stone-200 px-4 py-2 rounded-xl hover:border-stone-400 transition text-stone-600">Alertas de reputación →</Link>
              <Link href="/monitorizacion-reputacion/auditoria-reputacion-online/" className="text-sm border border-stone-200 px-4 py-2 rounded-xl hover:border-stone-400 transition text-stone-600">Auditoría gratuita →</Link>
          </div>
        </div>
      </div>
      <Footer />
