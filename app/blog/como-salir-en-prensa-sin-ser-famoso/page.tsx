  ...
  return (
    <div className="min-h-screen" style={{background:"var(--bg)"}}>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <h1 className="text-3xl md:text-4xl font-black text-stone-900 mb-5 leading-tight">Cómo salir en prensa siendo un desconocido (guía honesta)</h1>
        <p className="text-xl text-stone-600 leading-relaxed mb-8 border-l-4 border-amber-400 pl-4">Muchos coaches y empresarios quieren salir en prensa. Muchos servicios prometen cosas imposibles. Esta guía explica cómo funciona de verdad, qué es alcanzable para quién, y qué diferencia hay entre editorial y patrocinado.</p>
        
        <div className="prose prose-stone max-w-none">
          <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4">La diferencia entre editorial y patrocinado (y por qué importa)</h2>
          <p className="text-stone-600 leading-relaxed">Editorial: el medio decide publicar porque considera que la historia tiene valor informativo o de interés para sus lectores. El periodista o editor lo aprueba. El resultado aparece entre las noticias normales. Patrocinado (BrandVoice, contenido de marca): la empresa paga para publicar un artículo que parece editorial pero está marcado como publicidad. Tiene valor para SEO (backlink de autoridad), pero menor credibilidad. Muchos servicios de "aparecer en Forbes" venden BrandVoice como si fuera editorial. No es lo mismo.</p>

          <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4">Qué medios son accesibles para quién</h2>
          <p className="text-stone-600 leading-relaxed">Para la mayoría de profesionales y empresarios sin perfil público previo: medios regionales y sectoriales (alta tasa de éxito, bajo coste), Forbes Argentina o Entrepreneur LATAM editorial (accesible con historia sólida y proveedor adecuado), medios nacionales españoles de segundo nivel. Para quienes ya tienen perfil: medios nacionales de primer nivel. Para figuras con impacto internacional real: NYPost, BBC, Wired (proceso muy largo y costoso). La clave es calibrar qué es realista según tu perfil actual.</p>

          <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4">Cómo se consigue una aparición editorial real</h2>
          <p className="text-stone-600 leading-relaxed">El proceso real: 1) Identificar el ángulo de la historia (qué tiene de interesante para los lectores del medio). 2) Hacer el pitch correcto al periodista o redactor adecuado. 3) Tener material de apoyo: historia verificable, fotos, datos. 4) Tener paciencia: los medios no publican al ritmo del cliente. El error más común: pensar que "mis logros" son automáticamente interesantes para el medio. La pregunta correcta es: ¿por qué le interesa esto a los lectores del medio?</p>

          <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4">El valor real de aparecer en prensa para tu reputación</h2>
          <p className="text-stone-600 leading-relaxed">Un artículo en Forbes (Argentina o global) cumple varias funciones: genera un backlink de alta autoridad que mejora tu posicionamiento en Google, aparece en los resultados cuando buscan tu nombre, y facilita la activación del Knowledge Panel de Google porque es una fuente que Google reconoce. El retorno no es solo "ser famoso" — es construcción de autoridad verificable y documentada.</p>
        </div>
        ...
        <div className="mt-10 pt-8 border-t border-stone-200">
          ...
          <div className="flex flex-wrap gap-3">
              <Link href="/autoridad-digital/salir-en-prensa/" className="text-sm border border-stone-200 px-4 py-2 rounded-xl hover:border-stone-400 transition text-stone-600">Salir en prensa →</Link>
