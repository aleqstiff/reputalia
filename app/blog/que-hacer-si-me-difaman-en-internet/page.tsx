      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <div className="mt-10 pt-8 border-t border-white/[0.07]">
          ...
          <div className="flex flex-wrap gap-3">
              ...
              <Link href="/proteccion-reputacion/derecho-al-olvido/" className="text-sm border border-white/[0.07] px-4 py-2 rounded-xl hover:border-white/30 transition text-white/60">Derecho al olvido →</Link>
              <Link href="/proteccion-reputacion/suplantacion-identidad/" className="text-sm border border-white/[0.07] px-4 py-2 rounded-xl hover:border-white/30 transition text-white/60">Suplantación →</Link>
          </div>
        </div>
      </div>
      <Footer />
